...
/***/ "./src/admin/LoginAesSettingsPage.js":
/*!*******************************************!*\
  !*** ./src/admin/LoginAesSettingsPage.js ***!
  \*******************************************/
...
/* harmony export */   "default": () => (/* binding */ LoginAesSettingsPage)
/* harmony export */ });
...
var settingsPrefix = 'api_login.';
var localePrefix = 'api_login.admin.settings.';
var LoginAesSettingsPage = /*#__PURE__*/function (_ExtensionPage) {
  function LoginAesSettingsPage() {
    return _ExtensionPage.apply(this, arguments) || this;
  }
  (0,_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(LoginAesSettingsPage, _ExtensionPage);
  var _proto = LoginAesSettingsPage.prototype;
  ...
  _proto.content = function content() {
    ...
    return [m('.container', [m('.LoginAesSetting', [m('.Form-group', [m('label', flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans(localePrefix + 'aes_key')), m('input[type=text].FormControl', {
      bidi: this.setting(settingsPrefix + 'aes_key', ''),
      placeholder: '2',
      style: 'width:25%'
    })]), m('.Form-group', [m('label', flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans(localePrefix + 'aes_iv')), m('input[type=text].FormControl', {
      bidi: this.setting(settingsPrefix + 'aes_iv', ''),
      placeholder: '',
      style: 'width:25%'
    })]), m('.Form-group', [m('label', flarum_common_app__WEBPACK_IMPORTED_MODULE_1___default().translator.trans(localePrefix + 'rand')), m('input[type=text].FormControl', {
      bidi: this.setting(settingsPrefix + 'rand', ''),
      placeholder: '',
      style: 'width:25%'
    })]), this.submitButton()])])];
  };
  return LoginAesSettingsPage;
...
/* harmony import */ var _LoginAesSettingsPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LoginAesSettingsPage */ "./src/admin/LoginAesSettingsPage.js");


flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('thefunpower-api-login', function () {
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('thefunpower-api-login').registerPage(_LoginAesSettingsPage__WEBPACK_IMPORTED_MODULE_1__["default"]);
});
